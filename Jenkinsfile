...
void initialize() {
	...
	sh 'mkdir -p $WORKSPACE/mnt/$JOB_NAME/annotations/gaf/mod-centric || true'
	sh 'mkdir -p $WORKSPACE/mnt/$JOB_NAME/annotations/gaf/uniprot-centric || true'
	...
	sh 'mkdir -p $WORKSPACE/mnt/$JOB_NAME/internal/gpad-gpi/mod-centric || true'
	sh 'mkdir -p $WORKSPACE/mnt/$JOB_NAME/internal/gpad-gpi/uniprot-centric || true'
